...
class Model1sControllerTest < ActionController::TestCase
  ...
  test "should create model1" do
    assert_difference('Model1.count') do
      post :create, model1: { amount: @model1.amount, name: @model1.name, patient_name: @model1.patient_name }
    end
  ...
  test "should update model1" do
    patch :update, id: @model1, model1: { amount: @model1.amount, name: @model1.name, patient_name: @model1.patient_name }
    assert_redirected_to model1_path(assigns(:model1))
  end
